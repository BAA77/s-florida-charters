...
// gallery control
let gallerySlide = document.querySelector(".y-gallery-item");

document.querySelector(".gallery-control-right").addEventListener("click", () => {
    let galleryItem = document.querySelectorAll(".yacht-item");
    gallerySlide.appendChild(galleryItem[0]);
});

document.querySelector(".gallery-control-left").addEventListener("click", () => {
    let galleryItem = document.querySelectorAll(".yacht-item");
    gallerySlide.prepend(galleryItem[galleryItem.length - 1]);
});

document.querySelectorAll(".yacht-item").forEach((e) => {
...
let title = document.querySelector("#booking-req-h3").textContent.trim();
